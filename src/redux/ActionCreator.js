...
export const postComment = (dishId, rating, author, comment) => (dispatch) =>{
    ...
    },//when not hearing anything from the server
    error => {
...
export const fetchDishes = () => (dispatch) => {
    ...
    return fetch(baseUrl + 'dishes')
        ...
        .catch(error => dispatch(dishesFailed(error.message)));//handling the error in dishes
}
//returning a action object({})
