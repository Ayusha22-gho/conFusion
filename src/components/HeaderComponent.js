...
class Header extends Component {
    ...
    constructor(props) {
        ...
        this.toggleNav = this.toggleNav.bind(this);//another way to bind is using arrow function
        this.state = {
            isNavOpen: false,
            isModalOpen : false
        };
    ...
    handleLogin(event) {
        this.toggleModal();
        alert("Username: " + this.username.value + " Password: " + this.password.value + " Remamber: " + this.remember.checked);
    ...
    render() {
        return(
        <>
            <Navbar dark expand = "md">{/*show complete navbar when screen is medium and more */}
            ...
            // React fragment allows to group many elements
            //<React.Fragment> is the syntax, above is a shortform
