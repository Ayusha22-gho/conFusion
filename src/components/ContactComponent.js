...
const required = (val) => val && val.length;//checks that val >0
const maxLength = (len) => (val) => !(val) || (val.length <= len);
const minLength = (len) => (val) => !(val) || (val.length >= len);//grater than 0 and
const isNumber = (val) => !isNaN(Number(val));//checking that it is a number
                ...
                <div className= "row row-content">
                    ...
                    <div className= "col-12 col-md-9">
                        <Form model = "feedback" onSubmit= {(values) => this.handleSubmit(values)}>
                            <Row className = "form-group">{/*md= {2} means from medium to extra large it will occupy 2 columns */}
                            ...
                            <Row className = "form-group">{/*md= {2} means from medium to extra large it will occupy 2 columns */}
                                ...
                                <Col md = {10}>
                                    <Control.text model = ".email" id = "email" name = "email" placeholder = "Email Name"
                                    className = "form-control"
                                    validators ={
                                        {
                                            required , validEmail
