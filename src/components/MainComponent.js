    ...
    const DishWithId = ({match}) => {
      return(
        <DishDetail dish = {this.props.dishes.dishes.filter((dish) => dish.id === parseInt(match.params.dishId, 10))[0]}
          ...
          //dish will be array returning first item as [0] is uses,
          //comments will be an array, which is compared with dishId
        />
      );
    }
    ...
    <div>
     ...
     <TransitionGroup>
       <CSSTransition key = {this.props.location.key} classNames = "page" timeout= {300}>
        <Switch>
            {/* in order to be able to pass props we define it as function, for menucomponent */}
