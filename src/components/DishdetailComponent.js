...
const minLength = (len) => (val) => !(val) || (val.length >= len);
    ...
    class ComponentForm extends Component {
        ...
        <>
            <div >
                <Button outline onClick = {this.toggleModal} className = "primary">
    ...
    -                  </ Control.select>
                        ...
                        <Row className = "form-group">
                            ...
                            <Control.text model = ".author" id="username" name = "username" placeholder = "Your Name"
    ...
    const DishDetail = (props) => {//way of making component <DishDetail />
